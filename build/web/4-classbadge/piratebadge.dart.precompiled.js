...
["", "piratebadge.dart", , A, {
  ...
  updateBadge: [function(e) {
    ...
    t2.textContent = J.get$isEmpty$asx(t1._firstName) === true ? "" : H.S(t1._firstName) + " the " + H.S(t1._appellation);
  ...
  }, "call$1", "updateBadge$closure", 2, 0, 5],
  generateBadge: [function(e) {
    var t1, t2;
    t1 = A.PirateName$(null, null);
    t2 = document.querySelector("#badgeName");
    t2.textContent = J.get$isEmpty$asx(t1._firstName) === true ? "" : H.S(t1._firstName) + " the " + H.S(t1._appellation);
  }, "call$1", "generateBadge$closure", 2, 0, 5],
  PirateName: {
